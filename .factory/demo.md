...
- The demo loads a realistic three-row customer-import source and a five-column strict template. It opens on the mapped wiring stage so the first screen is already useful.
